                          ...
                          if (responsiveVisibility(
                            ...
                            Flexible(
                              child: Align(
                                ...
                                child: Lottie.asset(
                                  'assets/jsons/createAccount_(1).json',
                                  width:
                                          ...
                                          if (responsiveVisibility(
                                            ...
                                            FFButtonWidget(
                                              ...
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                '1xfwcutt' /* Create account | Pay my bill */,
                                              ),
                                        ...
                                        children: [
                                          if (responsiveVisibility(
                                            ...
                                            FFButtonWidget(
                                              ...
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'd6zv1npd' /* Create business account */,
                                              ),
                                              options: FFButtonOptions(
                                                width:
                                                    MediaQuery.sizeOf(context)
                              ...
                              children: [
                                if (responsiveVisibility(
                                  ...
                                  FFButtonWidget(
                                    ...
                                    text: FFLocalizations.of(context).getText(
                                      's8lmj6hv' /* Create business account */,
                                    ),
                                    icon: Icon(
                                      Icons.store_rounded,
                                      size: 15.0,
                                ...
                                if (responsiveVisibility(
                                  ...
                                  FFButtonWidget(
                                    ...
                                    text: FFLocalizations.of(context).getText(
                                      'pw63xvfx' /* Create account | Pay my bill */,
                                    ),
                                    icon: Icon(
                                      Icons.person,
                                      size: 15.0,
