                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return AlertDialog(
                                                                                  title: Text(FFLocalizations.of(context).getVariableText(
                                                                                    enText: 'Cancel invitation',
                                                                                    frText: 'Annuler l\'invitation',
                                                                                    deText: 'Einladung abbrechen',
                                                                                  )),
                                                                                  content: Text(FFLocalizations.of(context).getVariableText(
                                                                                    enText: 'Are you sure you want cancel invitation?',
                                                                                    frText: 'Êtes-vous sûr de vouloir annuler l\'invitation ?',
                                                                                    deText: 'Sind Sie sicher, dass Sie die Einladung absagen möchten?',
                                                                                  )),
                                                                                  actions: [
                                                                                    TextButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    var confirmDialogResponse =
                                                                        await showDialog<bool>(
                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return AlertDialog(
                                                                                  title: Text('Are you sure your want to remove the employee ?'),
                                                                                  content: Text('If you remove this employee, you will not be able to undo the action.'),
                                                                                  actions: [
                                                                                    TextButton(
                                                                                      onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                      child: Text('Cancel'),
