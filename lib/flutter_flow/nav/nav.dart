        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'CreateStore1',
              path: 'createStore1',
              builder: (context, params) => CreateStore1Widget(),
            ),
            FFRoute(
              name: 'CreateStore2',
              path: 'createStore2',
              builder: (context, params) => CreateStore2Widget(),
            ),
            FFRoute(
              name: 'Items',
              path: 'items',
            ...
            FFRoute(
              name: 'AddTable',
              path: 'addTable',
              builder: (context, params) => AddTableWidget(),
            ),
            FFRoute(
              name: 'NewOrder',
              path: 'newOrder',
            ...
            FFRoute(
              ...
              path: 'scanTable',
              requireAuth: true,
              builder: (context, params) => ChooseTableWidget(),
            ),
            FFRoute(
              name: 'InvitedUser',
              path: 'inviteduser/:invitationParams',
              asyncParams: {
                'invitationParams':
            ...
            FFRoute(
              ...
              path: 'team',
              requireAuth: true,
              builder: (context, params) => TeamWidget(),
            ),
            FFRoute(
              name: 'InvitePage',
              path: 'invitePage',
            ...
            FFRoute(
              name: 'InvitationPageCopyLink',
              path: 'copylink',
              builder: (context, params) => InvitationPageCopyLinkWidget(),
            ),
            FFRoute(
              name: 'ProductDetails',
              path: 'productDetails',
              asyncParams: {
                'productSelection':
                    getDoc(['MenuItems'], MenuItemsRecord.fromSnapshot),
                'orderparam': getDoc(['Carts'], CartsRecord.fromSnapshot),
