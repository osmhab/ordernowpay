...
class AddUpdateItemWidget extends StatefulWidget {
  const AddUpdateItemWidget({super.key});

  @override
  State<AddUpdateItemWidget> createState() => _AddUpdateItemWidgetState();
}
...
class _AddUpdateItemWidgetState extends State<AddUpdateItemWidget> {
  ...
  void initState() {
    ...
    _model.itemDescriptionTextController ??= TextEditingController();
