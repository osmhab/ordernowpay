...
class UpdateItemWidget extends StatefulWidget {
  ...
  @override
  _UpdateItemWidgetState createState() => _UpdateItemWidgetState();
}
...
class _UpdateItemWidgetState extends State<UpdateItemWidget> {
  ...
  void initState() {
    ...
    _model.itemDescriptionController ??=
        TextEditingController(text: widget.upadeItem?.description);
    _model.itemSpecificsController ??=
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model
                                                  .itemSpecificsControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ],
