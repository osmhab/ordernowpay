...
class CreateStore1Widget extends StatefulWidget {
  const CreateStore1Widget({Key? key}) : super(key: key);

  @override
  _CreateStore1WidgetState createState() => _CreateStore1WidgetState();
}
...
class _CreateStore1WidgetState extends State<CreateStore1Widget> {
  ...
  void initState() {
    ...
    _model.storeAdressController ??= TextEditingController();
    _model.storeCityController ??= TextEditingController();
