...
class _CreateStore2WidgetState extends State<CreateStore2Widget> {
  ...
  void initState() {
    ...
    _model.bankAdresseController ??= TextEditingController();
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 12.0, 16.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.bankAdresseController,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    validator: _model
                                        .bankAdresseControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await currentUserReference!
                                          ...
                                          bankAdress:
                                              _model.bankAdresseController.text,
                                          bankIBAN:
