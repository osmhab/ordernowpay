...
class CreateStore2Widget extends StatefulWidget {
  const CreateStore2Widget({Key? key}) : super(key: key);

  @override
  _CreateStore2WidgetState createState() => _CreateStore2WidgetState();
}
...
class _CreateStore2WidgetState extends State<CreateStore2Widget> {
  ...
  void initState() {
    ...
    _model.beneficiareNameController ??= TextEditingController();
    _model.beneficiaryAdresseController ??= TextEditingController();
    _model.bankIbanController ??= TextEditingController();
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          validator: _model
                                              .beneficiareNameControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await currentUserReference!
                                          ...
                                          bankIBAN:
                                              _model.bankIbanController.text,
                                          userRef: currentUserReference,
                                          beneficiaireAdresse: _model
                                              .beneficiaryAdresseController
                                              .text,
                                          beneficiaireName: _model
                                              .beneficiareNameController.text,
                                        ));
