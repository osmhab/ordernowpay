...
class TipSheetWidget extends StatefulWidget {
  ...
  @override
  _TipSheetWidgetState createState() => _TipSheetWidgetState();
}
...
class _TipSheetWidgetState extends State<TipSheetWidget> {
  ...
  void initState() {
    ...
    _model.tipAmountController ??= TextEditingController(
        text: formatNumber(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.orderParameters!.reference
                          ...
                          tip: double.tryParse(_model.tipAmountController.text),
                          total: functions.tipCalculate(
                              widget.orderParameters!.subtotal,
                              double.parse(_model.tipAmountController.text),
