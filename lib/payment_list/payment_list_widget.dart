                            ...
                            return InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    'cartsParams': serializeParam(
                                      listViewCartsRecord,
                                      ParamType.Document,
                                    ),
                                  }.withoutNulls,
                                  extra: <String, dynamic>{
                                    'cartsParams': listViewCartsRecord,
                                  },
                                );
                              },
                              child: Container(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        listViewCartsRecord.role == 'Staff'
                                            ? formatNumber(
                                                functions
                                                    .fraisStripeEtOrderNowCreatedByStaff(
                                                        listViewCartsRecord
                                                            .total,
                                                        3.9,
                                                        0.30,
                                            ...
                                            : formatNumber(
                                                functions
                                                    .fraisStripeEtOrderNowCreatedByAdmin(
                                                        listViewCartsRecord
                                                            .total,
                                                        3.9,
                                                        0.30,
